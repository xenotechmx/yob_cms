...
class CheckPaymentPendingWithOxxo extends Command
{
     ...
     * @var string
     */
    protected $signature = 'checkpendingpayment:oxxo';
...
//                        if (true) {
                        ...
                        if ($pending_order->job_id_to_publish != 0) {
                            ...
                            //Revisamos que exista y no se halla publicado el empleo anteriormente
                            $job_to_publish = Job::find($pending_order->job_id_to_publish);


                            if ($job_to_publish != null) {
                                if ($job_to_publish->status == "eraser") {
                                    ...
                                    echo $api_controller->post_job($request_to_post_job);
